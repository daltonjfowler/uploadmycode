/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5c2085690f95069c32f2f137eb37917)
...
interface __BaseEnv_Env {
	...
	COMPILER: DurableObjectNamespace<import("./src/worker").CompilerContainer>;
	COUNTERS: DurableObjectNamespace<import("./src/worker").Counters>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "CompilerContainer" | "Counters";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEACHER_KEY" | "ALLOWED_CIDRS">> {}
}
